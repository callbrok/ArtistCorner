package com.artistcorner.controller.guicontroller.mobile.getrecommendation;
...
public class GuiControllerMobileGetRecommendation implements Serializable {
    @FXML
    ...
    private GetRecommendation lcm = new GetRecommendation();
    ...
    public void switchToSceneMainArtistaFromRecM(ActionEvent event) throws IOException {
        SceneControllerMobile.switchToSceneMainArtista(event, art);
    }

    public void switchToProfiloArtistaFromRecM(ActionEvent event) throws SQLException, IOException {
        SceneControllerMobile.switchToSceneProfiloArtista(event, art);
    }

    public void switchToUploadOperaFromRecM(ActionEvent event) throws IOException {
        SceneControllerMobile.switchToSceneUploadOpera(event, art);
    }

    public void switchToProfiloVendutoFromRecM(ActionEvent event) throws IOException {
        SceneControllerMobile.switchToSceneProfiloVenduto(event, art);
    }

    public void switchToProfiloOfferteMostreFromRecM(ActionEvent event) throws IOException {
