...
public class GuiControllerUploadArtwork {
    @FXML
    public Button button1Up;
    @FXML
    public Button button2Up;
    @FXML
    public Button button3Up;
    @FXML
    public Button button4Up;
    @FXML
    public Button button5Up;
    @FXML
    public AnchorPane anchorParentUpload;
    @FXML
    ...
    @FXML
    public Label labelLogOutUpload;
    @FXML
    public RadioButton radioBtmSellUpload;
