    ...
    public void credentialLogin(UserBean noLoggedUserBean, ActionEvent event, String flagInterface) throws IOException, UserNotFoundException {
        ...
        switch (loggedUser.getRole()){
            ...
            case "artista":
                ...
                if(flagInterface.equals("D")){SceneController.switchToSceneMainArtista(event, loggedArtistBean);}   // Modalità Desktop.
                if(flagInterface.equals("M")){SceneControllerMobile.switchToSceneMainArtista(event, loggedArtistBean);}  // Modalità Mobile.
            ...
            case "galleria":
                ...
                if(flagInterface.equals("D")){SceneController.switchToSceneGallerySummary(event, loggedGalleryBean);}   // Modalità Desktop.
                if(flagInterface.equals("M")){SceneControllerMobile.switchToSceneGallerySummary(event, loggedGalleryBean);}  // Modalità Mobile.
            ...
            case "acquirente":
                ...
                if(flagInterface.equals("D")){SceneController.switchToSceneBuyerSummary(event, loggedBuyerBean);}   // Modalità Desktop.
                if(flagInterface.equals("M")){SceneControllerMobile.switchToSceneBuyerSummary(event, loggedBuyerBean);}  // Modalità Mobile.
