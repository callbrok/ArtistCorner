package com.artistcorner.controller.guicontroller.mobile.viewprofilogallery;
...
public class GuiControllerMobileViewProfiloGallery {
    ...
    public ListView<HBoxInitializer> listView;
    ...
    private void initializeTilePanePending(ArtGalleryBean gallery) throws SQLException, IOException {
        ViewProfileGallery vp = new ViewProfileGallery();
        ArrayList<Proposal> listOfProposal = vp.retrieveProposal(gallery,0);
        tilePane.setHgap(20);
        tilePane.setVgap(10);
        for (Proposal b : listOfProposal){
            ...
            Label nome= new Label(); nome.setText(string);nome.setAlignment(Pos.CENTER);
    ...
    private void initializeTilePaneAccepted(ArtGalleryBean gallery) throws SQLException, IOException {
        ViewProfileGallery vp = new ViewProfileGallery();
